...
import com.akkamelo.api.actor.client.ClientActor.{ClientActorPersistenceFailure, ClientActorResponse, ClientActorUnprocessableEntity, ClientBalanceAndLimitResponse, ClientStatementResponse}
